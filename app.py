...
ADVICE_MESSAGES = {
    ...
    'hi': {
        ...
        'mungbean_temp_low': "मूंग को इष्टतम विकास के लिए गर्म परिस्थितियों की आवश्यकता है।",
...
def load_models_and_scalers():
    ...
    try:
        ...
        if market_crop_encoder and (not hasattr(market_crop_encoder, 'categories_') or not market_crop_encoder.categories_[0].tolist()):
